...
public class CoffeeDBViewer extends JFrame
    ...
    */
    ...
    private void buildQueryPanel()
        ...
        JScrollPane qaScrollPane = new JScrollPane(queryTextArea);
        
        qaScrollPane.setHorizontalScrollBarPolicy( JScrollPane.HORIZONTAL_SCROLLBAR_NEVER); 
        
        qaScrollPane.setVerticalScrollBarPolicy( JScrollPane.VERTICAL_SCROLLBAR_AS_NEEDED);
